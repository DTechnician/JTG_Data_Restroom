SELECT
    ...
    details:vehicleDefLevelPercentage.vehicle.name::STRING AS vehicle_name,
    details:vehicleDefLevelPercentage.vehicle.serial::STRING AS vehicle_serial,
    details:vehicleDefLevelPercentage.vehicle.externalIds."samsara.serial"::STRING AS samsara_serial,
    details:vehicleDefLevelPercentage.vehicle.externalIds."samsara.vin"::STRING AS samsara_vin,
